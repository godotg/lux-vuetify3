...
protocols.set(852, new MidImagineAskRegistration());
protocolIdMap.set(MidImagineAsk, 852);
protocols.set(853, new MidImagineNotifyRegistration());
protocolIdMap.set(MidImagineNotify, 853);
protocols.set(854, new MidRerollAskRegistration());
protocolIdMap.set(MidRerollAsk, 854);
protocols.set(855, new MidSelectAskRegistration());
protocolIdMap.set(MidSelectAsk, 855);
protocols.set(856, new MidUpscaleAskRegistration());
protocolIdMap.set(MidUpscaleAsk, 856);
protocols.set(857, new MidZoomAskRegistration());
protocolIdMap.set(MidZoomAsk, 857);
protocols.set(858, new MidInpaintAskRegistration());
protocolIdMap.set(MidInpaintAsk, 858);
protocols.set(900, new SeoAskRegistration());
protocolIdMap.set(SeoAsk, 900);
protocols.set(901, new SdSimulateAskRegistration());
protocolIdMap.set(SdSimulateAsk, 901);
protocols.set(902, new SdSimulateAnswerRegistration());
protocolIdMap.set(SdSimulateAnswer, 902);
protocols.set(903, new SdSimulateNotifyRegistration());
protocolIdMap.set(SdSimulateNotify, 903);
