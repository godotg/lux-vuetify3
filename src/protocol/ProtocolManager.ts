...
protocols.set(210, new MarketRegistration());
protocolIdMap.set(Market, 210);
protocols.set(211, new SaveMarketAskRegistration());
protocolIdMap.set(SaveMarketAsk, 211);
protocols.set(212, new SaveMarketAnswerRegistration());
protocolIdMap.set(SaveMarketAnswer, 212);
protocols.set(213, new MarketRequestRegistration());
protocolIdMap.set(MarketRequest, 213);
protocols.set(214, new MarketResponseRegistration());
protocolIdMap.set(MarketResponse, 214);
protocols.set(220, new ConceptRegistration());
protocolIdMap.set(Concept, 220);
protocols.set(221, new ConceptRequestRegistration());
protocolIdMap.set(ConceptRequest, 221);
protocols.set(222, new ConceptResponseRegistration());
protocolIdMap.set(ConceptResponse, 222);
protocols.set(225, new EastMoneyRankRegistration());
protocolIdMap.set(EastMoneyRank, 225);
protocols.set(226, new ThsRankRegistration());
protocolIdMap.set(ThsRank, 226);
protocols.set(227, new RankRequestRegistration());
protocolIdMap.set(RankRequest, 227);
protocols.set(228, new RankResponseRegistration());
protocolIdMap.set(RankResponse, 228);
