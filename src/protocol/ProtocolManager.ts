...
protocols.set(1200, new AnimationRequestRegistration());
protocolIdMap.set(AnimationRequest, 1200);
protocols.set(1201, new AnimationNoticeRegistration());
protocolIdMap.set(AnimationNotice, 1201);
protocols.set(1202, new TransferAnimationAskRegistration());
protocolIdMap.set(TransferAnimationAsk, 1202);
protocols.set(1203, new TransferAnimationNotifyRegistration());
protocolIdMap.set(TransferAnimationNotify, 1203);
