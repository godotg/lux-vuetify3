...
import EastMoneyUSRank from './rank/EastMoneyUSRank';
import { EastMoneyUSRankRegistration } from './rank/EastMoneyUSRank';
...
import SaveBloomBergAsk from './trending/SaveBloomBergAsk';
import { SaveBloomBergAskRegistration } from './trending/SaveBloomBergAsk';
import SaveBloomBergAnswer from './trending/SaveBloomBergAnswer';
import { SaveBloomBergAnswerRegistration } from './trending/SaveBloomBergAnswer';
import TrendingRequest from './trending/TrendingRequest';
import { TrendingRequestRegistration } from './trending/TrendingRequest';
import TrendingResponse from './trending/TrendingResponse';
import { TrendingResponseRegistration } from './trending/TrendingResponse';
import Trending from './trending/Trending';
import { TrendingRegistration } from './trending/Trending';
...
import ChunkedFileUploadAsk from './broker/ChunkedFileUploadAsk';
import { ChunkedFileUploadAskRegistration } from './broker/ChunkedFileUploadAsk';
import ChunkedFileUploadAnswer from './broker/ChunkedFileUploadAnswer';
import { ChunkedFileUploadAnswerRegistration } from './broker/ChunkedFileUploadAnswer';
...
protocols.set(401, new EastMoneyUSRankRegistration());
protocolIdMap.set(EastMoneyUSRank, 401);
protocols.set(410, new RankRequestRegistration());
protocolIdMap.set(RankRequest, 410);
protocols.set(411, new RankResponseRegistration());
protocolIdMap.set(RankResponse, 411);
protocols.set(420, new SaveBloomBergAskRegistration());
protocolIdMap.set(SaveBloomBergAsk, 420);
protocols.set(421, new SaveBloomBergAnswerRegistration());
protocolIdMap.set(SaveBloomBergAnswer, 421);
protocols.set(425, new TrendingRequestRegistration());
protocolIdMap.set(TrendingRequest, 425);
protocols.set(426, new TrendingResponseRegistration());
protocolIdMap.set(TrendingResponse, 426);
protocols.set(427, new TrendingRegistration());
protocolIdMap.set(Trending, 427);
...
protocols.set(870, new ChunkedFileUploadAskRegistration());
protocolIdMap.set(ChunkedFileUploadAsk, 870);
protocols.set(871, new ChunkedFileUploadAnswerRegistration());
protocolIdMap.set(ChunkedFileUploadAnswer, 871);
