...
protocols.set(275, MidUpscaleRequest);
protocols.set(276, MidZoomRequest);
protocols.set(277, MidInpaintRequest);
...
protocols.set(306, MidUpscaleAsk);
protocols.set(307, MidZoomAsk);
protocols.set(308, MidInpaintAsk);
protocols.set(320, SeoAsk);
protocols.set(321, SdSimulateAsk);
protocols.set(322, SdSimulateAnswer);
protocols.set(323, SdSimulateNotify);
